    ...
    return (
        <>
            ...
            <Navbar.Brand as={Link} to="/"> <span className="fw-bolder fs-4 fst-italic">Smartphones-Warehouse </span>
                ...
                <Nav.Link> <NavLink className="custom-nav-text" to="/contact">Contact</NavLink></Nav.Link>
                    { user ?
                         <button className='btn btn-secondary text-white fw-bold text-decoration-none' onClick={handleLogOut}>Log Out</button>: <Nav.Link><NavLink className="custom-nav-text" to="/login">LogIn</NavLink></Nav.Link>
                    }                
                </Navbar.Collapse>
                </Container>
            </Navbar>
